...
class Settings(BaseSettings):
    ...
    embedding_readiness_timeout_seconds: float = Field(default=2, ge=0.1, le=10)
    embedding_identity_ttl_seconds: float = Field(default=10, ge=0.1, le=300)
    storage_readiness_ttl_seconds: float = Field(default=30, ge=0.1, le=3600)
    storage_readiness_failure_ttl_seconds: float = Field(default=5, ge=0.1, le=300)
    storage_readiness_wait_seconds: float = Field(default=2, ge=0.1, le=30)
